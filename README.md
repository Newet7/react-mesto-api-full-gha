...
1. [Mesto](https://github.com/Newet7/MESTOgram)
2. [Mesto (версия на React)](https://github.com/Newet7/MESTOgram)
3. [Mesto (версия на авторизацией и регистрацией)](https://github.com/Newet7/react-mesto-auth)
4. [Mesto (версия для сервера)](https://github.com/Newet7/express-mesto-gha)
...
- Фронтенд
  - React-приложение адаптировано под рабочий API-сервер
